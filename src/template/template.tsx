...
import {
  ...
  huskyConfigTemplate,
  codecovConfigTemplate,
  commitlintConfigTemplate,
  semanticReleaseConfigTemplate,
  travisCIConfigTemplate,
} from './files';
    ...
    <Directory name="">
      <Directory name=".github">
        <Directory name="ISSUE_TEMPLATE">
          ...
          />
          <File name="feature_request.md" data={githubFeatureRequestIssueTemplate} />
          <File name="bug_report.md" data={githubBugReportIssueTemplate} />
          <File name="question.md" data={githubQuestionIssueTemplate} />
        </Directory>
        <File name="pull_request_template.md" data={githubPullRequestTemplate} />
      </Directory>
      ...
      <File
        ...
        data={allContributorsConfigTemplate({
          projectName: props.packageName,
          projectOwner: props.repository.user,
        })}
      />
      ...
      <File name=".huskyrc.json" data={huskyConfigTemplate()} />
      <File name=".lintstagedrc" data={lintStagedConfigTemplate} />
      ...
      <File
        name=".releaserc.json"
        data={semanticReleaseConfigTemplate({ user: props.repository.user, repository: props.repository.repository })}
      />
      <File name=".travis.yml" data={travisCIConfigTemplate({ codeCov: true, codeClimate: true })} />
      <File name="CODE_OF_CONDUCT.md" data={codeOfConductTemplate(props.codeOfConduct.contactEmail)} />
      <File name="codecov.yml" data={codecovConfigTemplate()} />
      <File name="commitlint.config.js" data={commitlintConfigTemplate()} />
      <File name="CONTRIBUTING.md" data={contributingGuidelinesTemplate} />
      <File
        name="LICENSE"
        data={getLicense(license, { year: new Date().getFullYear().toString(), author: props.author.name })}
      />
      <File
        name="package.json"
        data={packageJsonTemplate({
